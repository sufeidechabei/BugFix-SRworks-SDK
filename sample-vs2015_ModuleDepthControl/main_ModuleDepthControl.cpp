	...
	while (true)
	{
		if (EnableKeyboardInput) {
			...
			// save to obj (VivePro.obj)
				...
				res = ViveSR_SetParameterBool(ID_DEPTH, ViveSR::Depth::Cmd::EXTRACT_DEPTH_MESH, flag_extract_depth_mesh);
				...
				res = ViveSR_SetParameterBool(ID_DEPTH, ViveSR::ModuleParam::ENABLE_FPSCONTROL, flag_enable_depth_fps_control);
				res = ViveSR_SetParameterInt(ID_DEPTH, ViveSR::ModuleParam::SET_FPS, nFPS);
