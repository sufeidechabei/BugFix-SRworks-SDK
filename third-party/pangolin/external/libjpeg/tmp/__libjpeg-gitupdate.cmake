...
execute_process(
  COMMAND "D:/Program Files/Git/cmd/git.exe" show-ref bc8f8be222287fec977ec3f47a5cb065cceb2ee9
  WORKING_DIRECTORY "D:/PCL/ext_lib/Pangolin-master/vs2013/external/libjpeg/src/__libjpeg"
...
# yet).
execute_process(
  COMMAND "D:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 bc8f8be222287fec977ec3f47a5cb065cceb2ee9
  WORKING_DIRECTORY "D:/PCL/ext_lib/Pangolin-master/vs2013/external/libjpeg/src/__libjpeg"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(need_stash)
      execute_process(
        COMMAND "D:/Program Files/Git/cmd/git.exe" stash save --quiet
        WORKING_DIRECTORY "D:/PCL/ext_lib/Pangolin-master/vs2013/external/libjpeg/src/__libjpeg"
        RESULT_VARIABLE error_code
        )
      if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/PCL/ext_lib/Pangolin-master/vs2013/external/libjpeg/src/__libjpeg/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/PCL/ext_lib/Pangolin-master/vs2013/external/libjpeg/src/__libjpeg/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
