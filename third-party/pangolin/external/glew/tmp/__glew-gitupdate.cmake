...
execute_process(
  COMMAND "D:/Program Files/Git/cmd/git.exe" show-ref 7574ab4d00b683e56adbfdec7da636529dfe65d8
  WORKING_DIRECTORY "D:/PCL/ext_lib/Pangolin-master/vs2013/external/glew/src/__glew"
...
# yet).
execute_process(
  COMMAND "D:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 7574ab4d00b683e56adbfdec7da636529dfe65d8
  WORKING_DIRECTORY "D:/PCL/ext_lib/Pangolin-master/vs2013/external/glew/src/__glew"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/PCL/ext_lib/Pangolin-master/vs2013/external/glew/src/__glew/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/PCL/ext_lib/Pangolin-master/vs2013/external/glew/src/__glew/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
