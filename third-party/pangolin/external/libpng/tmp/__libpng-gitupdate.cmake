...
execute_process(
  COMMAND "D:/Program Files/Git/cmd/git.exe" show-ref v1.6.18
  WORKING_DIRECTORY "D:/PCL/ext_lib/Pangolin-master/vs2013/external/libpng/src/__libpng"
...
# yet).
execute_process(
  COMMAND "D:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 v1.6.18
  WORKING_DIRECTORY "D:/PCL/ext_lib/Pangolin-master/vs2013/external/libpng/src/__libpng"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/PCL/ext_lib/Pangolin-master/vs2013/external/libpng/src/__libpng/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/PCL/ext_lib/Pangolin-master/vs2013/external/libpng/src/__libpng/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
